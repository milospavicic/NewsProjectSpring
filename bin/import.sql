...
INSERT INTO posts(title,description,photo,date,likes,dislikes,latitude,longitude,user_id)VALUES ('Post title 1','Post description 1','LOAD_FILE(C:\ProgramData\MySQL\MySQL Server 5.7\Uploads\1.png)','2018-1-1',5,5,45.264861,19.829698,1);
INSERT INTO posts(title,description,photo,date,likes,dislikes,latitude,longitude,user_id)VALUES ('Post title 2','Post description 2','LOAD_FILE(C:\ProgramData\MySQL\MySQL Server 5.7\Uploads\2.png)','2018-2-2',10,5,44.786568,20.448922,2);
INSERT INTO posts(title,description,photo,date,likes,dislikes,latitude,longitude,user_id)VALUES ('Post title 3','Post description 3','LOAD_FILE(C:\ProgramData\MySQL\MySQL Server 5.7\Uploads\3.png)','2018-2-3',110,4,45.264861,19.829698,2);
INSERT INTO posts(title,description,photo,date,likes,dislikes,latitude,longitude,user_id)VALUES ('Post title 4','Post description 4','LOAD_FILE(C:\ProgramData\MySQL\MySQL Server 5.7\Uploads\4.jpg)','2018-2-1',2,3,44.786568,20.448922,1);
INSERT INTO posts(title,description,photo,date,likes,dislikes,latitude,longitude,user_id)VALUES ('Post title 5','Post description 5','LOAD_FILE(C:\ProgramData\MySQL\MySQL Server 5.7\Uploads\5.jpg)','2018-4-1',10,15,36.123248,-5.452579,1);
